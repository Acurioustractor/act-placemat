...
CREATE TABLE IF NOT EXISTS linkedin_contacts (
  ...
  INDEX idx_linkedin_contacts_email (email_address),
  INDEX idx_linkedin_contacts_company (current_company),
  INDEX idx_linkedin_contacts_score (relationship_score DESC),
  INDEX idx_linkedin_contacts_strategic (strategic_value),
  INDEX idx_linkedin_contacts_source (data_source)
);
