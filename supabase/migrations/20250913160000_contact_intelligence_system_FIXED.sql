...
DROP POLICY IF EXISTS "Users can insert contact data" ON contact_interactions;
DROP POLICY IF EXISTS "Users can update contact data" ON contact_interactions;
DROP POLICY IF EXISTS "Users can view all research data" ON contact_research_log;
DROP POLICY IF EXISTS "Users can insert research data" ON contact_research_log;
DROP POLICY IF EXISTS "Users can view all campaigns" ON contact_campaigns;
DROP POLICY IF EXISTS "Users can manage campaigns" ON contact_campaigns;
DROP POLICY IF EXISTS "Users can view all campaign assignments" ON contact_campaign_assignments;
DROP POLICY IF EXISTS "Users can manage campaign assignments" ON contact_campaign_assignments;
DROP POLICY IF EXISTS "Users can view all relationships" ON contact_relationships;
DROP POLICY IF EXISTS "Users can manage relationships" ON contact_relationships;
DROP POLICY IF EXISTS "Users can view all scores" ON contact_intelligence_scores;
DROP POLICY IF EXISTS "Users can update scores" ON contact_intelligence_scores;
DROP POLICY IF EXISTS "Users can view all tasks" ON contact_tasks;
DROP POLICY IF EXISTS "Users can manage tasks" ON contact_tasks;

-- Create RLS policies
CREATE POLICY "Users can view all contact data" ON contact_interactions FOR SELECT USING (true);
CREATE POLICY "Users can insert contact data" ON contact_interactions FOR INSERT WITH CHECK (true);
CREATE POLICY "Users can update contact data" ON contact_interactions FOR UPDATE USING (true);

CREATE POLICY "Users can view all research data" ON contact_research_log FOR SELECT USING (true);
CREATE POLICY "Users can insert research data" ON contact_research_log FOR INSERT WITH CHECK (true);

CREATE POLICY "Users can view all campaigns" ON contact_campaigns FOR SELECT USING (true);
CREATE POLICY "Users can manage campaigns" ON contact_campaigns FOR ALL USING (true);

CREATE POLICY "Users can view all campaign assignments" ON contact_campaign_assignments FOR SELECT USING (true);
CREATE POLICY "Users can manage campaign assignments" ON contact_campaign_assignments FOR ALL USING (true);

CREATE POLICY "Users can view all relationships" ON contact_relationships FOR SELECT USING (true);
CREATE POLICY "Users can manage relationships" ON contact_relationships FOR ALL USING (true);

CREATE POLICY "Users can view all scores" ON contact_intelligence_scores FOR SELECT USING (true);
CREATE POLICY "Users can update scores" ON contact_intelligence_scores FOR ALL USING (true);

CREATE POLICY "Users can view all tasks" ON contact_tasks FOR SELECT USING (true);
CREATE POLICY "Users can manage tasks" ON contact_tasks FOR ALL USING (true);
