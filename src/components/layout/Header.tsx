 ...
 * Contains logo, mobile menu toggle, and user controls
 */
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            ...
            <Link 
              to={ROUTES.HOME} 
              className="md:hidden ml-2 flex-shrink-0 flex items-center"
            >
              <span className="text-xl font-bold text-primary-600">ACT Placemat</span>
            </Link>
          </div>
