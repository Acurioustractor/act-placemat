...
export function SectionHeader({ eyebrow, title, description, subtitle, actions }: SectionHeaderProps) {
  ...
  return (
    <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div className="space-y-2">
        ...
        {helperText && <p className="section-subtitle max-w-2xl">{helperText}</p>}
      </div>
