...
class BulletproofDataService {
  ...
  async getStories() {
    ...
    try {
      ...
      // Fallback data to keep system operational
      ...
      this.setCache(cacheKey, fallbackStories);
  ...
  async getStorytellers() {
    ...
    try {
      ...
      this.setCache(cacheKey, fallbackStorytellers);
      console.log(`⚠️  Using fallback storytellers data`);
      return fallbackStorytellers;
    }
  }
  ...
  async getLinkedInConnections() {
    ...
    try {
      ...
      this.setCache(cacheKey, fallbackConnections);
      console.log(`⚠️  Using fallback LinkedIn data`);
