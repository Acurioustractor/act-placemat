...
:schema create-constraint user_id_unique FOR (u:User) REQUIRE u.user_id IS UNIQUE;
:schema create-constraint user_email_unique FOR (u:User) REQUIRE u.email IS UNIQUE;
...
:schema create-constraint project_id_unique FOR (p:Project) REQUIRE p.project_id IS UNIQUE;
:schema create-constraint project_slug_unique FOR (p:Project) REQUIRE p.slug IS UNIQUE;
...
:schema create-constraint skill_name_unique FOR (s:Skill) REQUIRE s.name IS UNIQUE;
...
:schema create-constraint interest_name_unique FOR (i:Interest) REQUIRE i.name IS UNIQUE;
...
:schema create-constraint outcome_id_unique FOR (o:Outcome) REQUIRE o.outcome_id IS UNIQUE;
...
:schema create-constraint event_id_unique FOR (e:Event) REQUIRE e.event_id IS UNIQUE;
...
:schema create-constraint location_code_unique FOR (l:Location) REQUIRE l.location_code IS UNIQUE;
...
:schema create-constraint org_name_unique FOR (org:Organization) REQUIRE org.name IS UNIQUE;
...
:schema create-constraint collaboration_id_unique FOR (c:Collaboration) REQUIRE c.collaboration_id IS UNIQUE;
